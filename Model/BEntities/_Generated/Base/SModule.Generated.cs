...
namespace BEntities.Base 
{
	...
	/// -----------------------------------------------------------------------------
	[Serializable()]
	public partial class SModule : BEntity 
	{
        ...
        public IList<Activity> ListActivitys { get; set; }

        public IList<Page> ListPages { get; set; }
    ...
    /// <summary>
    /// Relationship enumerator SModule
    /// </summary>
    /// <remarks></remarks>
    public enum relSModule 
     { 
        Activitys, Pages
	}
