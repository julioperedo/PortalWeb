...
namespace BComponents.PiggyBank 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UsedProduct : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UsedProduct
        /// </summary>
        ...
        {
            BEI.UsedProduct Item = null;
            try 
            {
                using (DAL.UsedProduct dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UsedProduct
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UsedProduct</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEI.UsedProduct> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEI.UsedProduct> Items;
                using (DAL.UsedProduct dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UsedProduct</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UsedProduct
        /// </summary>
        /// <param name="Items">Object type UsedProduct</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEI.UsedProduct Item) 
        {
            bool bolOk = true;
