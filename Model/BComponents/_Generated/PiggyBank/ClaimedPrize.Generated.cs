...
namespace BComponents.PiggyBank
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ClaimedPrize : BCEntity
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ClaimedPrize
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type ClaimedPrize
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ClaimedPrize</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEI.ClaimedPrize> List(string Order, params Enum[] Relations)
        {
            try
            {
                IEnumerable<BEI.ClaimedPrize> Items;
                using (DAL.ClaimedPrize dal = new())
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ClaimedPrize</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ClaimedPrize
        /// </summary>
        /// <param name="Items">Object type ClaimedPrize</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEI.ClaimedPrize Item)
        {
            bool bolOk = true;
