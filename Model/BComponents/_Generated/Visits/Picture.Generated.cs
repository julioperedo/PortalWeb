...
namespace BComponents.Visits 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Picture : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Picture
        /// </summary>
        ...
        {
            BEV.Picture Item = null;
            try 
            {
                using (DAL.Picture dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Picture
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Picture</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type Picture</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Picture
        /// </summary>
        /// <param name="Items">Object type Picture</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEV.Picture Item) 
        {
            bool bolOk = true;
