...
namespace BComponents.Visits 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Person : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Person
        /// </summary>
        ...
        {
            BEV.Person Item = null;
            try 
            {
                using (DAL.Person dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Person
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Person</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type Person</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Person
        /// </summary>
        /// <param name="Items">Object type Person</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEV.Person Item) 
        {
            bool bolOk = true;
