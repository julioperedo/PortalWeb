...
namespace BComponents.Visits 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class VisitReception : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type VisitReception
        /// </summary>
        ...
        {
            BEV.VisitReception Item = null;
            try 
            {
                using (DAL.VisitReception dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type VisitReception
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type VisitReception</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEV.VisitReception> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEV.VisitReception> Items;
                using (DAL.VisitReception dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type VisitReception</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type VisitReception
        /// </summary>
        /// <param name="Items">Object type VisitReception</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEV.VisitReception Item) 
        {
            bool bolOk = true;
