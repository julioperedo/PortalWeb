...
namespace BComponents.Staff 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Member : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Member
        /// </summary>
        ...
        {
            BEF.Member Item = null;
            try 
            {
                using (DAL.Member dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Member
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Member</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type Member</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Member
        /// </summary>
        /// <param name="Items">Object type Member</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEF.Member Item) 
        {
            bool bolOk = true;
