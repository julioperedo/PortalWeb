...
namespace BComponents.Kbytes 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ClientStatus : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ClientStatus
        /// </summary>
        ...
        {
            BEK.ClientStatus Item = null;
            try 
            {
                using (DAL.ClientStatus dal = new()) 
                {
                    Item = dal.Search(CardCode, Year, Quarter, Relations);
                }
            } 
            catch(Exception ex) 
            {
        ...
        /// <summary>
        ///     Search for collection business objects of type ClientStatus
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ClientStatus</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEK.ClientStatus> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEK.ClientStatus> Items;
                using (DAL.ClientStatus dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ClientStatus</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ClientStatus
        /// </summary>
        /// <param name="Items">Object type ClientStatus</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEK.ClientStatus Item) 
        {
            bool bolOk = true;
