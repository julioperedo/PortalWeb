...
namespace BComponents.Kbytes 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class AcceleratorLot : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type AcceleratorLot
        /// </summary>
        ...
        {
            BEK.AcceleratorLot Item = null;
            try 
            {
                using (DAL.AcceleratorLot dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type AcceleratorLot
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type AcceleratorLot</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEK.AcceleratorLot> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEK.AcceleratorLot> Items;
                using (DAL.AcceleratorLot dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type AcceleratorLot</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type AcceleratorLot
        /// </summary>
        /// <param name="Items">Object type AcceleratorLot</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEK.AcceleratorLot Item) 
        {
            bool bolOk = true;
