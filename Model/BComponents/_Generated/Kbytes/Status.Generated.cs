...
namespace BComponents.Kbytes 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Status : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Status
        /// </summary>
        ...
        {
            BEK.Status Item = null;
            try 
            {
                using (DAL.Status dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Status
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Status</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type Status</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Status
        /// </summary>
        /// <param name="Items">Object type Status</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEK.Status Item) 
        {
            bool bolOk = true;
