...
namespace BComponents.Kbytes 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ClaimedAward : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ClaimedAward
        /// </summary>
        ...
        {
            BEK.ClaimedAward Item = null;
            try 
            {
                using (DAL.ClaimedAward dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ClaimedAward
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ClaimedAward</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEK.ClaimedAward> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEK.ClaimedAward> Items;
                using (DAL.ClaimedAward dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ClaimedAward</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ClaimedAward
        /// </summary>
        /// <param name="Items">Object type ClaimedAward</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEK.ClaimedAward Item) 
        {
            bool bolOk = true;
