...
namespace BComponents.Kbytes 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class StatusDetail : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type StatusDetail
        /// </summary>
        ...
        {
            BEK.StatusDetail Item = null;
            try 
            {
                using (DAL.StatusDetail dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type StatusDetail
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type StatusDetail</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEK.StatusDetail> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEK.StatusDetail> Items;
                using (DAL.StatusDetail dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type StatusDetail</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type StatusDetail
        /// </summary>
        /// <param name="Items">Object type StatusDetail</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEK.StatusDetail Item) 
        {
            bool bolOk = true;
