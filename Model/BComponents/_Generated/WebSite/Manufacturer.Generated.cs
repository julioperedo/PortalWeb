...
namespace BComponents.WebSite 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Manufacturer : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Manufacturer
        /// </summary>
        ...
        {
            BEW.Manufacturer Item = null;
            try 
            {
                using (DAL.Manufacturer dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Manufacturer
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Manufacturer</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEW.Manufacturer> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEW.Manufacturer> Items;
                using (DAL.Manufacturer dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Manufacturer</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Manufacturer
        /// </summary>
        /// <param name="Items">Object type Manufacturer</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEW.Manufacturer Item) 
        {
            bool bolOk = true;
