...
namespace BComponents.Online 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SaleState : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SaleState
        /// </summary>
        ...
        {
            BEO.SaleState Item = null;
            try 
            {
                using (DAL.SaleState dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SaleState
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SaleState</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEO.SaleState> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEO.SaleState> Items;
                using (DAL.SaleState dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type SaleState</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SaleState
        /// </summary>
        /// <param name="Items">Object type SaleState</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEO.SaleState Item) 
        {
            bool bolOk = true;
