...
namespace BComponents.Online 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class TempSaleDetail : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type TempSaleDetail
        /// </summary>
        ...
        {
            BEO.TempSaleDetail Item = null;
            try 
            {
                using (DAL.TempSaleDetail dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type TempSaleDetail
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type TempSaleDetail</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEO.TempSaleDetail> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEO.TempSaleDetail> Items;
                using (DAL.TempSaleDetail dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type TempSaleDetail</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type TempSaleDetail
        /// </summary>
        /// <param name="Items">Object type TempSaleDetail</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEO.TempSaleDetail Item) 
        {
            bool bolOk = true;
