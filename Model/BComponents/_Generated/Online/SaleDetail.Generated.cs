...
namespace BComponents.Online 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SaleDetail : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SaleDetail
        /// </summary>
        ...
        {
            BEO.SaleDetail Item = null;
            try 
            {
                using (DAL.SaleDetail dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SaleDetail
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SaleDetail</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEO.SaleDetail> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEO.SaleDetail> Items;
                using (DAL.SaleDetail dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type SaleDetail</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SaleDetail
        /// </summary>
        /// <param name="Items">Object type SaleDetail</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEO.SaleDetail Item) 
        {
            bool bolOk = true;
