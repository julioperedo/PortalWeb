...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ProfileChart : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ProfileChart
        /// </summary>
        ...
        {
            BES.ProfileChart Item = null;
            try 
            {
                using (DAL.ProfileChart dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ProfileChart
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ProfileChart</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.ProfileChart> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.ProfileChart> Items;
                using (DAL.ProfileChart dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ProfileChart</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ProfileChart
        /// </summary>
        /// <param name="Items">Object type ProfileChart</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.ProfileChart Item) 
        {
            bool bolOk = true;
