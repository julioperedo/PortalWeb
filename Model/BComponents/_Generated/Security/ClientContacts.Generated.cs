...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ClientContacts : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ClientContacts
        /// </summary>
        ...
        {
            BES.ClientContacts Item = null;
            try 
            {
                using (DAL.ClientContacts dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ClientContacts
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ClientContacts</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.ClientContacts> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.ClientContacts> Items;
                using (DAL.ClientContacts dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ClientContacts</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ClientContacts
        /// </summary>
        /// <param name="Items">Object type ClientContacts</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.ClientContacts Item) 
        {
            bool bolOk = true;
