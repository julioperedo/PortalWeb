...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserRequest : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserRequest
        /// </summary>
        ...
        {
            BES.UserRequest Item = null;
            try 
            {
                using (DAL.UserRequest dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserRequest
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserRequest</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserRequest> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.UserRequest> Items;
                using (DAL.UserRequest dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserRequest</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserRequest
        /// </summary>
        /// <param name="Items">Object type UserRequest</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserRequest Item) 
        {
            bool bolOk = true;
