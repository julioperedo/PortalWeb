...
namespace BComponents.Security
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserData : BCEntity
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserData
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type UserData
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserData</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserData> List(string Order, params Enum[] Relations)
        {
            try
            {
                IEnumerable<BES.UserData> Items;
                using (DAL.UserData dal = new())
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserData</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserData
        /// </summary>
        /// <param name="Items">Object type UserData</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserData Item)
        {
            bool bolOk = true;
