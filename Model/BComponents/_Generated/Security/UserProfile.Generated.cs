...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserProfile : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserProfile
        /// </summary>
        ...
        {
            BES.UserProfile Item = null;
            try 
            {
                using (DAL.UserProfile dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserProfile
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserProfile</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserProfile> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.UserProfile> Items;
                using (DAL.UserProfile dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserProfile</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserProfile
        /// </summary>
        /// <param name="Items">Object type UserProfile</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserProfile Item) 
        {
            bool bolOk = true;
