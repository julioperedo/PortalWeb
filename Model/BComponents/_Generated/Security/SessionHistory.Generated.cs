...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SessionHistory : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SessionHistory
        /// </summary>
        ...
        {
            BES.SessionHistory Item = null;
            try 
            {
                using (DAL.SessionHistory dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SessionHistory
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SessionHistory</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.SessionHistory> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.SessionHistory> Items;
                using (DAL.SessionHistory dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type SessionHistory</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SessionHistory
        /// </summary>
        /// <param name="Items">Object type SessionHistory</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.SessionHistory Item) 
        {
            bool bolOk = true;
