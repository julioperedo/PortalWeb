...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserPerson : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserPerson
        /// </summary>
        ...
        {
            BES.UserPerson Item = null;
            try 
            {
                using (DAL.UserPerson dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserPerson
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserPerson</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserPerson> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.UserPerson> Items;
                using (DAL.UserPerson dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserPerson</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserPerson
        /// </summary>
        /// <param name="Items">Object type UserPerson</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserPerson Item) 
        {
            bool bolOk = true;
