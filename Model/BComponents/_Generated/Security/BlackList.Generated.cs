...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class BlackList : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type BlackList
        /// </summary>
        ...
        {
            BES.BlackList Item = null;
            try 
            {
                using (DAL.BlackList dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type BlackList
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type BlackList</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.BlackList> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.BlackList> Items;
                using (DAL.BlackList dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type BlackList</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type BlackList
        /// </summary>
        /// <param name="Items">Object type BlackList</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.BlackList Item) 
        {
            bool bolOk = true;
