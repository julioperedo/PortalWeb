...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserClient : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserClient
        /// </summary>
        ...
        {
            BES.UserClient Item = null;
            try 
            {
                using (DAL.UserClient dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserClient
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserClient</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserClient> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.UserClient> Items;
                using (DAL.UserClient dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserClient</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserClient
        /// </summary>
        /// <param name="Items">Object type UserClient</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserClient Item) 
        {
            bool bolOk = true;
