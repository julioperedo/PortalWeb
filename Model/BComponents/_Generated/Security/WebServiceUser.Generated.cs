...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class WebServiceUser : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type WebServiceUser
        /// </summary>
        ...
        {
            BES.WebServiceUser Item = null;
            try 
            {
                using (DAL.WebServiceUser dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type WebServiceUser
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type WebServiceUser</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.WebServiceUser> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.WebServiceUser> Items;
                using (DAL.WebServiceUser dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type WebServiceUser</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type WebServiceUser
        /// </summary>
        /// <param name="Items">Object type WebServiceUser</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.WebServiceUser Item) 
        {
            bool bolOk = true;
