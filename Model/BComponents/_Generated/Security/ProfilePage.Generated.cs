...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ProfilePage : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ProfilePage
        /// </summary>
        ...
        {
            BES.ProfilePage Item = null;
            try 
            {
                using (DAL.ProfilePage dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ProfilePage
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ProfilePage</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.ProfilePage> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.ProfilePage> Items;
                using (DAL.ProfilePage dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ProfilePage</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ProfilePage
        /// </summary>
        /// <param name="Items">Object type ProfilePage</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.ProfilePage Item) 
        {
            bool bolOk = true;
