...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserRequestDetail : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserRequestDetail
        /// </summary>
        ...
        {
            BES.UserRequestDetail Item = null;
            try 
            {
                using (DAL.UserRequestDetail dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserRequestDetail
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserRequestDetail</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.UserRequestDetail> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.UserRequestDetail> Items;
                using (DAL.UserRequestDetail dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserRequestDetail</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserRequestDetail
        /// </summary>
        /// <param name="Items">Object type UserRequestDetail</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.UserRequestDetail Item) 
        {
            bool bolOk = true;
