...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class RejectedMails : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type RejectedMails
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type RejectedMails
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type RejectedMails</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.RejectedMails> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.RejectedMails> Items;
                using (DAL.RejectedMails dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type RejectedMails</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type RejectedMails
        /// </summary>
        /// <param name="Items">Object type RejectedMails</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.RejectedMails Item) 
        {
            bool bolOk = true;
