...
namespace BComponents.Security 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ProfileActivity : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ProfileActivity
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type ProfileActivity
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ProfileActivity</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BES.ProfileActivity> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BES.ProfileActivity> Items;
                using (DAL.ProfileActivity dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ProfileActivity</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ProfileActivity
        /// </summary>
        /// <param name="Items">Object type ProfileActivity</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BES.ProfileActivity Item) 
        {
            bool bolOk = true;
