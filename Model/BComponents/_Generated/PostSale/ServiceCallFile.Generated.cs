...
namespace BComponents.PostSale 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ServiceCallFile : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ServiceCallFile
        /// </summary>
        ...
        {
            BET.ServiceCallFile Item = null;
            try 
            {
                using (DAL.ServiceCallFile dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ServiceCallFile
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ServiceCallFile</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BET.ServiceCallFile> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BET.ServiceCallFile> Items;
                using (DAL.ServiceCallFile dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ServiceCallFile</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ServiceCallFile
        /// </summary>
        /// <param name="Items">Object type ServiceCallFile</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BET.ServiceCallFile Item) 
        {
            bool bolOk = true;
