...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class LineDetail : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type LineDetail
        /// </summary>
        ...
        {
            BEP.LineDetail Item = null;
            try 
            {
                using (DAL.LineDetail dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type LineDetail
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type LineDetail</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.LineDetail> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.LineDetail> Items;
                using (DAL.LineDetail dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type LineDetail</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type LineDetail
        /// </summary>
        /// <param name="Items">Object type LineDetail</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.LineDetail Item) 
        {
            bool bolOk = true;
