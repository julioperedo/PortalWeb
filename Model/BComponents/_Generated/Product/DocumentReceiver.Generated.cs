...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class DocumentReceiver : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type DocumentReceiver
        /// </summary>
        ...
        {
            BEP.DocumentReceiver Item = null;
            try 
            {
        ...
        /// <summary>
        ///     Search for collection business objects of type DocumentReceiver
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type DocumentReceiver</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.DocumentReceiver> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.DocumentReceiver> Items;
                using (DAL.DocumentReceiver dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type DocumentReceiver</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type DocumentReceiver
        /// </summary>
        /// <param name="Items">Object type DocumentReceiver</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.DocumentReceiver Item) 
        {
            bool bolOk = true;
