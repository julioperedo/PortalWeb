...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class PromoBannerTrigger : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type PromoBannerTrigger
        /// </summary>
        ...
        {
            BEP.PromoBannerTrigger Item = null;
            try 
            {
                using (DAL.PromoBannerTrigger dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type PromoBannerTrigger
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type PromoBannerTrigger</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.PromoBannerTrigger> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.PromoBannerTrigger> Items;
                using (DAL.PromoBannerTrigger dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type PromoBannerTrigger</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type PromoBannerTrigger
        /// </summary>
        /// <param name="Items">Object type PromoBannerTrigger</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.PromoBannerTrigger Item) 
        {
            bool bolOk = true;
