...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class PromoBanner : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type PromoBanner
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type PromoBanner
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type PromoBanner</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.PromoBanner> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.PromoBanner> Items;
                using (DAL.PromoBanner dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type PromoBanner</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type PromoBanner
        /// </summary>
        /// <param name="Items">Object type PromoBanner</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.PromoBanner Item) 
        {
            bool bolOk = true;
