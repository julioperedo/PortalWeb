...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class OpenBoxHistory : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type OpenBoxHistory
        /// </summary>
        ...
        {
            BEP.OpenBoxHistory Item = null;
            try 
            {
                using (DAL.OpenBoxHistory dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type OpenBoxHistory
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type OpenBoxHistory</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.OpenBoxHistory> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.OpenBoxHistory> Items;
                using (DAL.OpenBoxHistory dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type OpenBoxHistory</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type OpenBoxHistory
        /// </summary>
        /// <param name="Items">Object type OpenBoxHistory</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.OpenBoxHistory Item) 
        {
            bool bolOk = true;
