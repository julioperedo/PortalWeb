...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Document : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Document
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type Document
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Document</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.Document> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.Document> Items;
                using (DAL.Document dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Document</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Document
        /// </summary>
        /// <param name="Items">Object type Document</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.Document Item) 
        {
            bool bolOk = true;
