...
namespace BComponents.Product 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class OpenBox : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type OpenBox
        /// </summary>
        ...
        {
            BEP.OpenBox Item = null;
            try 
            {
                using (DAL.OpenBox dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type OpenBox
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type OpenBox</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type OpenBox</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type OpenBox
        /// </summary>
        /// <param name="Items">Object type OpenBox</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.OpenBox Item) 
        {
            bool bolOk = true;
