...
namespace BComponents.Product 
{
    ...
    /// </remarks>
    /// <history>
    ///   [DMC]   4/3/2022 21:28:37 Created
    /// </history>
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class ClientAllowed : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type ClientAllowed
        /// </summary>
        ...
        {
            BEP.ClientAllowed Item = null;
            try 
            {
                using (DAL.ClientAllowed dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type ClientAllowed
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type ClientAllowed</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEP.ClientAllowed> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEP.ClientAllowed> Items;
                using (DAL.ClientAllowed dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type ClientAllowed</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type ClientAllowed
        /// </summary>
        /// <param name="Items">Object type ClientAllowed</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEP.ClientAllowed Item) 
        {
            bool bolOk = true;
