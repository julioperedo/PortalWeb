...
namespace BComponents.Sales 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Transport : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Transport
        /// </summary>
        ...
        {
            BEL.Transport Item = null;
            try 
            {
                using (DAL.Transport dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Transport
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Transport</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEL.Transport> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEL.Transport> Items;
                using (DAL.Transport dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Transport</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Transport
        /// </summary>
        /// <param name="Items">Object type Transport</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEL.Transport Item) 
        {
            bool bolOk = true;
