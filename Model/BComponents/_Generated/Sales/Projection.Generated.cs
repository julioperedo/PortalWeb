...
namespace BComponents.Sales 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Projection : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Projection
        /// </summary>
        ...
        {
            BEL.Projection Item = null;
            try 
            {
                using (DAL.Projection dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Projection
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Projection</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEL.Projection> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEL.Projection> Items;
                using (DAL.Projection dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Projection</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Projection
        /// </summary>
        /// <param name="Items">Object type Projection</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEL.Projection Item) 
        {
            bool bolOk = true;
