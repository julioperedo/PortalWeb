...
namespace BComponents.HumanResources 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Vacation : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Vacation
        /// </summary>
        ...
        {
            BEH.Vacation Item = null;
            try 
            {
                using (DAL.Vacation dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Vacation
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Vacation</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEH.Vacation> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEH.Vacation> Items;
                using (DAL.Vacation dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Vacation</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Vacation
        /// </summary>
        /// <param name="Items">Object type Vacation</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEH.Vacation Item) 
        {
            bool bolOk = true;
