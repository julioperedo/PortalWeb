...
namespace BComponents.HumanResources 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class EmployeeDepartment : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type EmployeeDepartment
        /// </summary>
        ...
        {
            BEH.EmployeeDepartment Item = null;
            try 
            {
                using (DAL.EmployeeDepartment dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type EmployeeDepartment
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type EmployeeDepartment</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEH.EmployeeDepartment> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEH.EmployeeDepartment> Items;
                using (DAL.EmployeeDepartment dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type EmployeeDepartment</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type EmployeeDepartment
        /// </summary>
        /// <param name="Items">Object type EmployeeDepartment</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEH.EmployeeDepartment Item) 
        {
            bool bolOk = true;
