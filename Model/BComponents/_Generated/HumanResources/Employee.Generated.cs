...
namespace BComponents.HumanResources
{
	...
	/// -----------------------------------------------------------------------------
	[Serializable()]
	public partial class Employee : BCEntity
	{

		#region Search Methods 

		/// <summary>
		///     Search for business objects of type Employee
		/// </summary>
		...
		/// <summary>
		///     Search for collection business objects of type Employee
		/// </summary>
		/// <param name="Order">Property column to specify collection order</param>
		/// <param name="Relations">Relationship enumerator</param>
		/// <returns>Object collection of type Employee</returns>
		/// <remarks>
		///     To get relationship objects, suply relationship enumetators
		/// </remarks>
		...
		/// </summary>
		/// <param name="Item">Object type Employee</param>     
		/// <remarks>
		/// </remarks>
		...
		/// <summary>
		///     Saves data object of type Employee
		/// </summary>
		/// <param name="Items">Object type Employee</param>
		/// <remarks>
		/// </remarks>
		...
		/// <remarks>
		/// </remarks>
		internal bool Validate(BEH.Employee Item)
		{
			bool bolOk = true;
