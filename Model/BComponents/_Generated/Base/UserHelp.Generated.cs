...
namespace BComponents.Base 
{
    ...
    /// </remarks>
    /// <history>
    ///   [DMC]   4/3/2022 21:28:20 Created
    /// </history>
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserHelp : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserHelp
        /// </summary>
        ...
        {
            BEB.UserHelp Item = null;
            try 
            {
                using (DAL.UserHelp dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type UserHelp
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserHelp</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEB.UserHelp> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEB.UserHelp> Items;
                using (DAL.UserHelp dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserHelp</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserHelp
        /// </summary>
        /// <param name="Items">Object type UserHelp</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.UserHelp Item) 
        {
            bool bolOk = true;
