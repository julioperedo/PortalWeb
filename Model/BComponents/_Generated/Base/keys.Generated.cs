...
namespace BComponents.Base 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class keys : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type keys
        /// </summary>
        ...
        public BEB.keys Search(string Tabla, params Enum[] Relations) 
        {
            ...
            try 
            {
                using (DAL.keys dal = new()) 
                {
                    Item = dal.Search(Tabla, Relations);
                }
            } 
            catch(Exception ex) 
            {
        ...
        /// <summary>
        ///     Search for collection business objects of type keys
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type keys</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type keys</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type keys
        /// </summary>
        /// <param name="Items">Object type keys</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.keys Item) 
        {
            bool bolOk = true;
