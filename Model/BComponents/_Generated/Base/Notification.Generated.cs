...
namespace BComponents.Base 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Notification : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Notification
        /// </summary>
        ...
        {
            BEB.Notification Item = null;
            try 
            {
                using (DAL.Notification dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Notification
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Notification</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEB.Notification> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEB.Notification> Items;
                using (DAL.Notification dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Notification</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Notification
        /// </summary>
        /// <param name="Items">Object type Notification</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.Notification Item) 
        {
            bool bolOk = true;
