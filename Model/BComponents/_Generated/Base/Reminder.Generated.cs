...
namespace BComponents.Base 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Reminder : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Reminder
        /// </summary>
        ...
        {
            BEB.Reminder Item = null;
            try 
            {
                using (DAL.Reminder dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Reminder
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Reminder</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEB.Reminder> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEB.Reminder> Items;
                using (DAL.Reminder dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Reminder</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Reminder
        /// </summary>
        /// <param name="Items">Object type Reminder</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.Reminder Item) 
        {
            bool bolOk = true;
