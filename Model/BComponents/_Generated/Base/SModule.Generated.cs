...
namespace BComponents.Base 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SModule : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SModule
        /// </summary>
        ...
        {
            BEB.SModule Item = null;
            try 
            {
                using (DAL.SModule dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SModule
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SModule</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        ...
        /// </summary>
        /// <param name="Item">Object type SModule</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SModule
        /// </summary>
        /// <param name="Items">Object type SModule</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.SModule Item) 
        {
            bool bolOk = true;
