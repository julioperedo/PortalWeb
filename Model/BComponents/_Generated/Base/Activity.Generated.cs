...
namespace BComponents.Base 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class Activity : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type Activity
        /// </summary>
        ...
        {
            BEB.Activity Item = null;
            try 
            {
                using (DAL.Activity dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type Activity
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type Activity</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BEB.Activity> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BEB.Activity> Items;
                using (DAL.Activity dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type Activity</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type Activity
        /// </summary>
        /// <param name="Items">Object type Activity</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BEB.Activity Item) 
        {
            bool bolOk = true;
