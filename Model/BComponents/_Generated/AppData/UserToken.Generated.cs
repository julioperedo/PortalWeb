...
namespace BComponents.AppData 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class UserToken : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type UserToken
        /// </summary>
        ...
        /// <summary>
        ///     Search for collection business objects of type UserToken
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type UserToken</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BED.UserToken> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BED.UserToken> Items;
                using (DAL.UserToken dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type UserToken</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type UserToken
        /// </summary>
        /// <param name="Items">Object type UserToken</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BED.UserToken Item) 
        {
            bool bolOk = true;
