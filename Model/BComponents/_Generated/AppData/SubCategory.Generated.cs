...
namespace BComponents.AppData 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SubCategory : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SubCategory
        /// </summary>
        ...
        {
            BED.SubCategory Item = null;
            try 
            {
                using (DAL.SubCategory dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SubCategory
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SubCategory</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BED.SubCategory> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BED.SubCategory> Items;
                using (DAL.SubCategory dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type SubCategory</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SubCategory
        /// </summary>
        /// <param name="Items">Object type SubCategory</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BED.SubCategory Item) 
        {
            bool bolOk = true;
