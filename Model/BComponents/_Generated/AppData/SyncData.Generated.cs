...
namespace BComponents.AppData 
{
    ...
    /// -----------------------------------------------------------------------------
    [Serializable()]
    public partial class SyncData : BCEntity 
    {

        #region Search Methods 

        /// <summary>
        ///     Search for business objects of type SyncData
        /// </summary>
        ...
        {
            BED.SyncData Item = null;
            try 
            {
                using (DAL.SyncData dal = new()) 
                {
        ...
        /// <summary>
        ///     Search for collection business objects of type SyncData
        /// </summary>
        /// <param name="Order">Property column to specify collection order</param>
        /// <param name="Relations">Relationship enumerator</param>
        /// <returns>Object collection of type SyncData</returns>
        /// <remarks>
        ///     To get relationship objects, suply relationship enumetators
        /// </remarks>
        public IEnumerable<BED.SyncData> List(string Order, params Enum[] Relations) 
        {
            try 
            {
                IEnumerable<BED.SyncData> Items;
                using (DAL.SyncData dal = new()) 
                {
        ...
        /// </summary>
        /// <param name="Item">Object type SyncData</param>     
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///     Saves data object of type SyncData
        /// </summary>
        /// <param name="Items">Object type SyncData</param>
        /// <remarks>
        /// </remarks>
        ...
        /// <remarks>
        /// </remarks>
        internal bool Validate(BED.SyncData Item) 
        {
            bool bolOk = true;
