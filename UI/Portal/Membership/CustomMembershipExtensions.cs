...
namespace Portal.Membership {
    public static class CustomMembershipExtensions {
        public static IServiceCollection AddCustomMembership<T>(this IServiceCollection services, Action<CustomMembershipOptions> options) where T : class, ICustomMembership {
